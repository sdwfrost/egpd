...
The `egpd` package provides bamlss family constructors
...
that allow fitting continuous and discrete EGPD models (with optional
...
both [`egpd()`](https://sdwfrost.github.io/egpd/reference/egpd.md)
(penalised likelihood via GAM) and
[`bamlss()`](http://www.bamlss.org/reference/bamlss.md) (backfitting
with the
[`egpd_bamlss()`](https://sdwfrost.github.io/egpd/reference/egpd_bamlss.md)
family).
...
![](bamlss-comparison_files/figure-html/egpd-smooth-compare-1.png)

## Zero-inflated continuous EGPD

The
[`ziegpd_bamlss()`](https://sdwfrost.github.io/egpd/reference/ziegpd_bamlss.md)
family supports zero-inflated continuous EGPD models, which are useful
for data with excess zeros such as precipitation.
...
The
[`degpd_bamlss()`](https://sdwfrost.github.io/egpd/reference/degpd_bamlss.md)
family allows fitting discrete EGPD models via bamlss. We compare
[`egpd()`](https://sdwfrost.github.io/egpd/reference/egpd.md) (penalised
likelihood) and [`bamlss()`](http://www.bamlss.org/reference/bamlss.md)
on simulated count data.
...
The
[`zidegpd_bamlss()`](https://sdwfrost.github.io/egpd/reference/zidegpd_bamlss.md)
family supports zero-inflated discrete EGPD models.
