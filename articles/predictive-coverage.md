...
function computes simulation-based prediction intervals for fitted EGPD
models and reports their empirical coverage. This vignette demonstrates
its use for all three fitting approaches —
[`egpd()`](https://sdwfrost.github.io/egpd/reference/egpd.md),
[`gamlss()`](https://rdrr.io/pkg/gamlss/man/gamlss.html), and
[`bamlss()`](http://www.bamlss.org/reference/bamlss.md) — and shows how
to construct calibration plots that compare nominal and empirical
coverage across a range of levels.
...
![](predictive-coverage_files/figure-html/calibration-plugin-plot-1.png)
...
![](predictive-coverage_files/figure-html/calibration-parametric-plot-1.png)
...
![](predictive-coverage_files/figure-html/smooth-calibration-plot-1.png)
...
![](predictive-coverage_files/figure-html/forecast-cal-plugin-plot-1.png)
...
![](predictive-coverage_files/figure-html/forecast-cal-parametric-plot-1.png)
...
![](predictive-coverage_files/figure-html/forecast-interval-plot-1.png)
...
The
[`predictive_coverage()`](https://sdwfrost.github.io/egpd/reference/predictive_coverage.md)
function provides a straightforward way to assess the calibration of
EGPD-family models fitted via any of the three supported frameworks. Key
takeaways:
