...
Maximum likelihood and Bernstein polynomial fitting of univariate EGPD
distributions.
...
## Compound Poisson EGPD Distributions

Compound Poisson EGPD distribution functions for aggregated data.
...
## Compound Poisson-Discrete EGPD Distributions

Exact compound Poisson-Discrete EGPD distribution functions for
integer-valued aggregated data.
